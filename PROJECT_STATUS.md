...
9. **Premium sports-site features** (approved by Chris) — IN PROGRESS (PR #42):
   ...
   - Next: 5k → Hyrox pace calculator (Run Zone), founding-member seat counts on plan cards (configurable, honest), results wall / "Dina's week" (dated, consented), race countdown (confirmed dates only).
