...
9. **Premium sports-site features** (approved by Chris) — IN PROGRESS (PR #42):
   ...
   - **Pace calculator + next-race target** — DONE: Run Zone has 5k → Hyrox run pace / station estimate / finish window, and a "last two races → safe / realistic / stretch target" tool (rule of thumb, not a promise). Station-split comparison ("paste your splits") deferred until verified Indonesian splits exist.
